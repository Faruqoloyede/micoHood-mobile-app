  ...
  return (
    <FlatList
      ...
      renderItem={({ item }) => (
        ...
        >
          <View className="flex-1 justify-center items-center pt-32 bg-black/50 px-5">
              ...
              {slides.map((_, index) => (
                <View
                  ...
                  className={`w-3 h-3 mx-1 rounded-full ${
                    currentIndex === index ? "bg-primary" : "bg-white/40"
                  }`}
                />
              ))}
            </View>
            ...
            <View className="flex-row items-center justify-between mt-20 w-full">
              ...
              {currentIndex === slides.length - 1 ? (
                <View className="flex items-center w-full">
                  <Pressable
                    onPress={() => router.push("/sign-in")}
                    className="bg-primary py-4 px-12 rounded-[16px] mb-5 w-full"
                  >
                ...
                <Pressable
                  onPress={handleNext}
                  className="py-4 px-12 bg-primary rounded-[16px]"
                >
                  <Text className="text-white font-geist-medium text-[16px]">
                    Next
                  </Text>
